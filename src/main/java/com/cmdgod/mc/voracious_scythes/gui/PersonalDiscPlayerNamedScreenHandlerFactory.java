...
public class PersonalDiscPlayerNamedScreenHandlerFactory implements NamedScreenHandlerFactory {
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        player.sendMessage(Text.of("createMenu called! " + VoraciousScythes.returnServerOrClientString(player.getWorld())), false);
        return new PersonalDiscPlayerDescription(syncId, playerInventory, new PersonalDiscPlayerInventory(stack), ScreenHandlerContext.create(player.getWorld(), player.getBlockPos()));
    }
