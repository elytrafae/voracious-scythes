...
public class ScytheAbilityBase {
    ...
    public final static DefaultedRegistry<ScytheAbilityBase> ABILITY_REGISTRY = new DefaultedRegistry<ScytheAbilityBase>(VoraciousScythes.MOD_NAMESPACE + ":noid", RegistryKey.ofRegistry(new Identifier("cmdgod_scythe_ability")), Lifecycle.experimental(), null);
