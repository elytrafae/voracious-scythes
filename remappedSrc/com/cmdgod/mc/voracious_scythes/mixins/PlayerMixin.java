...
import com.cmdgod.mc.voracious_scythes.inventories.PersonalJukeboxInventory;
...
public abstract class PlayerMixin extends LivingEntity implements PlayerExtension {
    ...
    private void personalJukeboxTick(PlayerMixin playerExt, PlayerEntity player) {
        if (player.getOffHandStack().getItem() instanceof PosableMannequin) {
    ...
    private void personalJukeboxPlaySong(Identifier id) {
        ...
        personalSoundInstance = new PositionedSoundInstance(id, SoundCategory.MUSIC, 1, 1, false, 0, SoundInstance.AttenuationType.NONE, 0, 0, 0, true);
